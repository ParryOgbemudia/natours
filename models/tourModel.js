...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      minlength: [
        10,
        'A tour name must be more than 10 characters and less than 40 characters',
      ],
    ...
    ratingsAverage: {
      type: Number,
      default: 4.5,
      min: [1, 'Rating must be between 1 or 5'],
...
tourSchema.pre('save', async function (next) {
  if (!this.guides || this.guides.length === 0)
    return next(new AppError('You have no guide!', 401));
